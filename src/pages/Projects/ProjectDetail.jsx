...
import { readMoreLabel } from '../../data/siteData';
    ...
    useEffect(() => {
        async function loadProject() {
            try {
                ...
                // slug comes from route, but getProjects returns array of objects with slug property (filename)
                // or slug property derived from filename if not in frontmatter.
                // Let's find by filename (slug)
    ...
    return (
        <article className="post-detail-container">
            <div style={{ marginBottom: '30px' }}>
                <Link to="/projects" style={{ fontSize: '0.9rem', color: 'var(--text-muted)' }}>← Back to Projects</Link>
            </div>
